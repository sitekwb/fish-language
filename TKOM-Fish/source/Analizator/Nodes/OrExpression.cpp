...
#include <Analizator/Nodes/OrExpression.h>


using namespace std;


OrExpression::OrExpression(std::list<bool> &&unaryNotList, std::list<RelativeExpressionUP> &&relativeExpressionList,
                           std::list<RelativeOperatorUP> &&relativeOperatorList)
        : unaryNotList(move(unaryNotList)),
          relativeOperatorList(move(relativeOperatorList)),
          relativeExpressionList(move(relativeExpressionList)) {
